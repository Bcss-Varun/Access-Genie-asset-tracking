  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <PageHeader
        ...
        actions={<Link to="/support"><Button variant="primary">Contact support</Button></Link>}
      />
      ...
      <div className="glass-panel rounded-xl overflow-hidden">
        ...
        {results.length === 0 ? (
          <EmptyState
            ...
            action={<Link to="/support"><Button variant="outline" size="sm">Contact support</Button></Link>}
          />
        ) : (
          <div className="divide-y divide-slate-100">
            {results.map((a) => (
              <Link key={a.slug} to={`/help/${a.slug}`} className="flex items-center justify-between gap-4 px-4 py-4 hover:bg-slate-50 transition-colors group">
