...
export default function AiIntelligenceDashboard() {
  return (
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 p-0 overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
            ...
            <Link to="/ai/anomaly" className="text-xs font-medium text-primary-600 hover:underline">Anomaly console →</Link>
          </div>
      ...
      <Card title="Ranked Insight Feed" action={<Link to="/ai-insights" className="text-xs font-medium text-primary-600 hover:underline">All insights →</Link>}>
        <div className="space-y-3">
          {rankedInsights.map((ins, i) => (
            <Link key={ins.id} to="/ai-insights" className="flex items-start gap-3 p-3 rounded-lg border border-slate-200 hover:border-primary-500/50 transition-colors">
