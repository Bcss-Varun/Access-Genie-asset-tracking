                ...
                return (
                  <tr key={r.id} className={cn('transition-colors', exception ? 'bg-red-50/50 hover:bg-red-50' : 'hover:bg-slate-50')}>
                    <td className="px-6 py-4">
                      <Link to={`/assets/${r.assetId}`} className="font-medium text-slate-900 hover:text-primary-600 transition-colors">
                        {r.assetName}
                      </Link>
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link to={`/custody/${r.assetId}`} className="text-primary-600 hover:text-primary-700 text-xs font-medium">
                        View chain →
                      </Link>
                    </td>
                  </tr>
