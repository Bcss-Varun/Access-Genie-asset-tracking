    ...
    return (
      <div className="h-full flex flex-col space-y-6">
        <EmptyState
          ...
          action={<Link to="/procurement"><Button variant="outline">← Back to Procurement</Button></Link>}
        />
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="text-sm text-slate-500">
        Supplier{' '}
        <Link to={`/suppliers/${po.supplierId}`} className="text-primary-600 hover:text-primary-700 font-medium">
          {po.supplierName}
        </Link>
      </div>
