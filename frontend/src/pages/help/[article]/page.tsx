  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <PageHeader
        ...
        actions={<Link to="/help"><Button variant="outline">← All articles</Button></Link>}
      />
        ...
        <aside className="space-y-6">
          <div className="glass-panel rounded-xl p-5">
            ...
            <ul className="space-y-2">
              {related.map((a) => (
                <li key={a.slug}>
                  <Link to={`/help/${a.slug}`} className="text-sm text-primary-600 hover:text-primary-700 hover:underline">{a.title}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div className="glass-panel rounded-xl p-5">
            ...
            <Link to="/support"><Button variant="primary" size="sm" className="w-full">Contact support</Button></Link>
          </div>
        </aside>
      </div>
    </div>
