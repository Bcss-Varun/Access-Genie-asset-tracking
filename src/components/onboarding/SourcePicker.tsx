...
import { ASSET_PO_LINES, SCAN_RESULTS, UNKNOWN_TAG_READS, type AssetPoLine } from '@/lib/onboarding-sources';
...
import type { RegisteredAsset, RegistrationSeed, SourceKey } from '@/types/onboarding';
...
function seedFromPo(line: AssetPoLine): RegistrationSeed {
  ...
  return {
    ...
    locationId: locationIdFor(line.facilityHint),
        ...
        <button
          ...
          onClick={() =>
            onPick({
              ...
              preboundTag: { tagId: t.tagId, kind: t.kind },
            })
          }
        ...
        >
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-xs text-slate-600">
              {t.kind} · {t.facility} ▸ {t.zone} · {t.reads24h} reads in 24h · first seen {t.firstSeen}
            </p>
          </div>
