...
import { formatMoney, cn, DEMO_NOW } from '@/lib/utils';
import type { DocType } from '@/types/asset';
import type { CommercialData, GateResult, Ownership, RegisteredAsset } from '@/types/onboarding';
    ...
    patchOnboarding(asset.id, {
      documents: [
        ...ob.documents,
        {
          ...
          addedAt: new Date(DEMO_NOW).toISOString(),
        },
      ],
    });
