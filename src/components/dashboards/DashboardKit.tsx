...
export function InsightPanel({
  ...
  return (
    <Card
      title={title}
      action={
        <Link href={viewAllHref} className="text-xs font-medium px-2 py-1 bg-primary-500/10 text-primary-600 rounded-full hover:bg-primary-500/20 transition-colors">
          View all
        </Link>
      }
    >
