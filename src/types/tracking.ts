 ...
 */
export type LocationPrecision = 'Precise' | 'Room' | 'Site' | 'Last scan';
...
export type CustodyState = 'In Place' | 'Checked Out' | 'In Transit' | 'Unaccounted';
...
export type RoomKind = 'Storeroom' | 'Data Hall' | 'Secure Cage' | 'Staging' | 'Dock';
...
export type RackSlotState = 'Present' | 'Missing' | 'Unexpected' | 'Empty';
...
export type AuditState = 'Scheduled' | 'In Progress' | 'Review' | 'Approved' | 'Closed';
 ...
 */
export type AuditMethod = 'Automatic' | 'Assisted' | 'Manual';
...
export type UnknownState = 'New' | 'Investigating' | 'Matched' | 'Registered' | 'Ignored';
...
export type ExceptionKind =
  ...
  | 'Duplicate'
  | 'Unverified'
  | 'Ghost'; // on the books, never once detected
...
export type TrackingAlertCategory =
  | 'Missing Asset'
...
export type IncidentState = 'Open' | 'Investigating' | 'Contained' | 'Resolved' | 'Closed';
 ...
 */
export type DeviceRole = 'Tag' | 'Reader' | 'Gateway' | 'Anchor' | 'Scan Station' | 'Sensor';

export type DeviceState = 'Healthy' | 'Degraded' | 'Offline' | 'Maintenance' | 'Unprovisioned';
