...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="text-center">
        ...
        <Link href="/login" className="mt-6 inline-block text-sm font-medium text-primary-600 hover:underline">
          ← Back to sign in
        </Link>
      </div>
    );
  ...
  return (
    <div>
      ...
      <Link href="/login" className="mt-6 inline-block text-sm font-medium text-slate-500 hover:text-slate-800">
        ← Back to sign in
      </Link>
    </div>
  );
