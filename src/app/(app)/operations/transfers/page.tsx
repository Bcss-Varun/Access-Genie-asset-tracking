...
const SEED: Transfer[] = [
  {
    id: 'TR-4001', assetId: 'AST-1002', assetName: 'Portable X-Ray Machine',
    from: 'General Hospital · North Wing', to: 'General Hospital · South Wing',
    requester: 'Dr. Robert Chen', approver: 'Sarah Jenkins',
    status: 'Pending', requestedAt: hoursAgo(2),
    reason: 'Rebalance idle unit to over-capacity radiology.',
  },
  {
    id: 'TR-4002', assetId: 'AST-1009', assetName: 'Reach Truck RT-220',
    from: 'Central Warehouse · Service Bay', to: 'Central Warehouse · Production Bay 1',
    requester: 'Diego Martinez', approver: 'Miguel Ortiz',
    status: 'Approved', requestedAt: hoursAgo(6),
    reason: 'Return to floor after drive-belt replacement.',
  },
  {
    id: 'TR-4003', assetId: 'AST-1005', assetName: 'Ford Transit Delivery Van',
    from: 'Central Warehouse · Yard', to: 'General Hospital · Loading Dock',
    requester: 'Marcus Bell', approver: 'Sarah Jenkins',
    status: 'In Transit', requestedAt: hoursAgo(9),
    reason: 'Courier run — medical consumables delivery.',
  },
  {
    id: 'TR-4004', assetId: 'AST-1014', assetName: 'Autonomous Mobile Robot AMR-7',
    from: 'Central Warehouse · Commissioning', to: 'Central Warehouse · Main Warehouse',
    requester: 'Automation Team', approver: 'Sarah Jenkins',
    status: 'Pending', requestedAt: hoursAgo(3),
    reason: 'Move to live pick zone after commissioning sign-off.',
  },
  {
    id: 'TR-4005', assetId: 'AST-1011', assetName: 'Diesel Generator 250kW',
    from: 'Central Warehouse · Utility Yard', to: 'Primary Data Center · Yard',
    requester: 'Facilities Team', approver: 'Miguel Ortiz',
    status: 'Received', requestedAt: hoursAgo(28),
    reason: 'Redeploy backup power to data-center perimeter.',
  },
  {
    id: 'TR-4006', assetId: 'AST-1012', assetName: 'Zebra RFID Gateway G-4',
    from: 'Central Warehouse · Loading Dock 4', to: 'Central Warehouse · Cold Storage',
    requester: 'IoT Platform', approver: 'Sarah Jenkins',
    status: 'In Transit', requestedAt: hoursAgo(5),
    reason: 'Improve read coverage over cold-chain aisle.',
  },
];
