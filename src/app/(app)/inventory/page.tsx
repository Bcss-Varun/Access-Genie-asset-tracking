                ...
                {visible.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-slate-50 transition-colors">
                      <td className={td}>
                        <Link href={`/inventory/${p.sku}`} className="font-medium text-slate-900 hover:text-primary-600">
                          {p.sku}
                        </Link>
                      ...
                      <td className={td}>
                        <Link href={`/warehouses/${p.warehouseId}`} className="text-primary-600 hover:text-primary-700 font-medium">
