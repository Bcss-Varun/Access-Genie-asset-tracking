    ...
    return (
      <div className="h-full flex flex-col space-y-6">
        <EmptyState
          ...
          action={<Link href="/groups"><Button variant="outline">← Back to Groups</Button></Link>}
        />
      </div>
    );
  }
                    ...
                    <td className={td}>
                      <div className="flex items-center">
                        ...
                        <div className="min-w-0">
                          <Link href={`/assets/${m.id}`} className="font-medium text-slate-900 hover:text-primary-600">{m.name}</Link>
