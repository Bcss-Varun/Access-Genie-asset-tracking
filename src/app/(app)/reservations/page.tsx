...
const RESERVATIONS: Reservation[] = [
  { id: 'RES-7001', assetId: 'AST-1005', assetName: 'Ford Transit Delivery Van', reservedBy: 'Marcus Bell', startDay: 0, endDay: 1, startLabel: 'Mon 08:00', endLabel: 'Tue 17:00', status: 'In Use' },
  { id: 'RES-7002', assetId: 'AST-1001', assetName: 'Caterpillar Forklift Model X', reservedBy: 'Diego Martinez', startDay: 1, endDay: 2, startLabel: 'Tue 09:00', endLabel: 'Wed 12:00', status: 'Confirmed' },
  { id: 'RES-7003', assetId: 'AST-1010', assetName: 'Ultrasound Scanner U-9', reservedBy: 'Dr. Amara Osei', startDay: 2, endDay: 2, startLabel: 'Wed 07:00', endLabel: 'Wed 15:00', status: 'Confirmed' },
  { id: 'RES-7004', assetId: 'AST-1005', assetName: 'Ford Transit Delivery Van', reservedBy: 'Facilities Team', startDay: 1, endDay: 2, startLabel: 'Tue 13:00', endLabel: 'Wed 10:00', status: 'Pending' },
  { id: 'RES-7005', assetId: 'AST-1007', assetName: 'CNC Milling Machine #3', reservedBy: 'Elena Ortiz', startDay: 3, endDay: 4, startLabel: 'Thu 06:00', endLabel: 'Fri 18:00', status: 'Confirmed' },
  { id: 'RES-7006', assetId: 'AST-1011', assetName: 'Diesel Generator 250kW', reservedBy: 'Cold Chain Ops', startDay: 5, endDay: 6, startLabel: 'Sat 08:00', endLabel: 'Sun 20:00', status: 'Pending' },
];
            ...
            <tbody className="divide-y divide-slate-100">
              {reservations.map((r) => (
                <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/assets/${r.assetId}`} className="font-medium text-slate-800 hover:text-primary-600 transition-colors">
                      {r.assetName}
                    </Link>
                  </td>
