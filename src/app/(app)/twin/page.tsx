...
const FACILITIES: Facility[] = [
  {
    ...
    building: 'Building A · Loading, Production & Cold Chain',
    blurb: 'Live UWB + RFID grid across dock, warehouse, production and yard zones.',
    emoji: '🏭',
  },
  {
    ...
    building: 'North & South Wings · Clinical',
    blurb: 'BLE-tracked medical fleet with geofenced wards and custody monitoring.',
    emoji: '⚕️',
  },
  {
