            ...
            <div key={r.id} className="glass-panel rounded-xl p-5 flex flex-col hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <Link href={`/reports/${r.id}`} className="font-heading font-semibold text-slate-900 hover:text-primary-600">
                    {r.name}
                  </Link>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center gap-2">
                <Link href={`/reports/${r.id}`} className="mr-auto text-sm font-medium text-primary-600 hover:text-primary-700">
                  Open →
                </Link>
