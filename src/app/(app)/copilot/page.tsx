  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {top.map((a) => (
          <Link key={a.id} href={`/assets/${a.id}`} className="flex items-center justify-between p-3 rounded-lg bg-white border border-slate-200 hover:border-primary-300 transition-colors">
