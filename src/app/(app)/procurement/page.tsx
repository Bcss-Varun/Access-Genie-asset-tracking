              ...
              {filtered.map((po: PurchaseOrder) => (
                <tr key={po.id} className="hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4">
                    <Link href={`/procurement/${po.id}`} className="font-mono text-xs font-semibold text-primary-600 hover:text-primary-700">
                      {po.id}
                    </Link>
                  </td>
                  <td className="px-6 py-4">
                    <Link href={`/suppliers/${po.supplierId}`} className="text-slate-700 hover:text-primary-600 font-medium">
                      {po.supplierName}
                    </Link>
                  </td>
                  <td className="px-6 py-4">
