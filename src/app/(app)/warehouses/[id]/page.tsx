...
import { getWarehouse, getPartsForWarehouse } from '@/lib/mock-data';
    ...
    return (
      <div className="h-full flex flex-col space-y-6">
        <EmptyState
          ...
          action={<Link href="/warehouses"><Button variant="outline">← Back to Warehouses</Button></Link>}
        />
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <PageHeader
        ...
        actions={<Link href="/warehouses"><Button variant="outline">← All Warehouses</Button></Link>}
      />
                  ...
                  return (
                    <tr key={p.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/60 transition-colors">
                      <td className="px-5 py-3">
                        <Link href={`/inventory/${p.sku}`} className="font-mono text-xs font-medium text-primary-600 hover:underline">
                          {p.sku}
                        </Link>
                      </td>
