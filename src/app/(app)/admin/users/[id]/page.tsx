    ...
    return (
      <div className="h-full flex flex-col space-y-6">
        <EmptyState
          ...
          action={<Link href="/admin/users"><Button variant="outline">← Back to Users</Button></Link>}
        />
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <PageHeader
        ...
        actions={<Link href="/admin/users"><Button variant="outline">← All Users</Button></Link>}
      />
