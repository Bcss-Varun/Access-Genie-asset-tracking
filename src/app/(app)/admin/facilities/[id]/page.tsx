    ...
    return (
      <div className="h-full flex flex-col space-y-6">
        <EmptyState
          ...
          action={<Link href="/admin/facilities"><Button variant="outline">← Back to Facilities</Button></Link>}
        />
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      <PageHeader
        ...
        actions={<Link href="/admin/facilities"><Button variant="outline">← All Facilities</Button></Link>}
      />
