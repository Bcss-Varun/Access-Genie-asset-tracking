                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <h3 className="text-lg font-heading font-bold text-slate-900">
                      <Link href={`/assets/${item.assetId}`} className="hover:text-primary-600">{item.assetName}</Link>
                    </h3>
                  </div>
        ...
        <div className="glass-panel rounded-xl p-5 self-start">
          ...
          <div className="mt-3 space-y-1.5">
            {items.map((item) => {
              ...
              return (
                <Link key={item.assetId} href={`/assets/${item.assetId}`} className="flex items-center gap-2 text-xs text-slate-600 hover:text-primary-600">
