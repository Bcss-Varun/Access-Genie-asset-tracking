...
import type { JourneyEventKind, JourneyStop } from '@/types/tracking';
  ...
  return (
    <div className="space-y-5 pb-4">
      ...
      <Drawer
        ...
        footer={journey && (
          <>
            <Link href={`/tracking?asset=${journey.assetId}`}>
              <Button size="sm" variant="outline">Locate now</Button>
            </Link>
            <Link href={`/assets/${journey.assetId}`}>
            ...
            {journey.gaps > 0 && (
              <div className="mb-5 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5">
                ...
                <p className="mt-0.5 text-xs text-amber-800">
                  ...
                  <Link href="/tracking/infrastructure?tab=readers" className="font-semibold underline underline-offset-2">
                    Review coverage →
                  </Link>
                </p>
              </div>
