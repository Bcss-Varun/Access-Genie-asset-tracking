...
export const list = asyncHandler(async (req: Request, res: Response) => {
  sendData(res, await service.listTechnicians(requireScope(req)));
});

export const create = asyncHandler(async (req: Request, res: Response) => {
  const technician = await service.createTechnician(req.body as CreateTechnicianInput, requireScope(req));
...
export const update = asyncHandler(async (req: Request, res: Response) => {
  ...
  const technician = await service.updateTechnician(id, req.body as UpdateTechnicianInput, requireScope(req));
